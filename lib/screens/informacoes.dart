    ...
    return Scaffold(
      ...
      body: Column(
        children: [
          ...
          Card(
            margin:
                const EdgeInsets.only(top: 40, right: 20, left: 20, bottom: 16),
            ...
            child: ListTile(
              ...
              trailing: Container(
                ...
                child: IconButton(
                    icon: Image.asset('assets/images/git.png'),
                    onPressed: () => {
                          _launchInBrowser('https://github.com/Alexandre16347')
                        }),
              ),
              subtitle: Text(
          ...
          Card(
            margin:
                const EdgeInsets.only(top: 20, right: 20, left: 20, bottom: 16),
            shape: RoundedRectangleBorder(
              borderRadius: BorderRadius.circular(10),
            ),
            elevation: 20,
